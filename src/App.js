...
import { ADDITION, CLEAR, DIVISION, MULTIPLICATION, NUMBER, RESULT, SUBSCRACTION } from "./reducer/actions/actions";
      ...
      {console.log('newState',newState)}
       <div className="container">
          <form action="true" name="calc" className="calculator">
            ...
            <span className="num" onClick={()=>{ dispatch({type:SUBSCRACTION})  }}><i>-</i></span>
